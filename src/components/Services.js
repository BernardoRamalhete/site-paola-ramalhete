...
function Services({ showArrow, setProduct, setModal, pageWidth }) {
    ...
    const individualServices = [
        ...
        },
        {
            ...
            img: acessorios,
            price: 'R$250,00',
            description: 'Nessa sessão você descobrirá o poder dos acessórios em mudar completamente um look. Te auxiliarei a usá-los a seu favor de forma prática trazendo mais autonomia e versatilidade ao seu guarda roupas.',
